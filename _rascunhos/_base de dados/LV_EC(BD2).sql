...
CREATE TABLE Funcionario (
  ...
  Pessoa_codigoPessoa INTEGER UNSIGNED NOT NULL,
  cargo VARCHAR(20) NOT NULL,
  PRIMARY KEY(codigoFuncionario),
  INDEX Funcionario_FKIndex1(Pessoa_codigoPessoa),
...
CREATE TABLE Produtos (
  ...
  Funcionario_codigoFuncionario INTEGER UNSIGNED NOT NULL,
...
CREATE TABLE Cliente (
  ...
  INDEX Cliente_FKIndex1(Pessoa_codigoPessoa),
  FOREIGN KEY(Pessoa_codigoPessoa)
    REFERENCES Pessoa(codigoPessoa)
      ON DELETE NO ACTION
      ON UPDATE NO ACTION
...
CREATE TABLE Banco (
  ...
  valorDaAberturaDeConta DECIMAL NOT NULL,
  fotografia LONGBLOB NOT NULL,
  PRIMARY KEY(codigoBanco),
  INDEX Banco_FKIndex1(Pessoa_codigoPessoa),
  FOREIGN KEY(Pessoa_codigoPessoa)
    REFERENCES Pessoa(codigoPessoa)
      ON DELETE NO ACTION
      ON UPDATE NO ACTION
...
CREATE TABLE CartaoBanco (
  codigoCartaoBanco INTEGER UNSIGNED NOT NULL AUTO_INCREMENT,
  Pessoa_codigoPessoa INTEGER UNSIGNED NOT NULL,
  Banco_codigoBanco INTEGER UNSIGNED NOT NULL,
  iban TEXT NOT NULL,
  numeroDeConta TEXT NOT NULL,
  numeroDeContaCompleto TEXT NULL,
  valorNaConta DECIMAL NOT NULL,
  numeroDeContaElectronica TEXT NOT NULL,
  pin INTEGER UNSIGNED NOT NULL,
  estado VARCHAR(15) NOT NULL,
  PRIMARY KEY(codigoCartaoBanco),
  INDEX CartaoBanco_FKIndex1(Banco_codigoBanco),
  INDEX CartaoBanco_FKIndex2(Pessoa_codigoPessoa),
...
CREATE TABLE Usuario (
  ...
  INDEX Usuario_FKIndex1(Cliente_codigoCliente),
  INDEX Usuario_FKIndex2(Funcionario_codigoFuncionario),
  INDEX Usuario_FKIndex3(Pessoa_codigoPessoa),
...
CREATE TABLE login (
  ...
  Usuario_codigoUsuario INTEGER UNSIGNED NOT NULL,
  dataDeEntrada DATETIME NULL,
  dataDeSaida DATETIME NULL,
  PRIMARY KEY(codigoLogin),
  INDEX login_FKIndex1(Usuario_codigoUsuario),
